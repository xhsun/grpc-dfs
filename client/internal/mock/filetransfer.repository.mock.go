...
import (
	...
	filetransfer "github.com/xhsun/grpc-file-transfer/filetransfer"
)
...
func (_m *FileTransferRepositoryMock) Download(stream filetransfer.FileTransfer_FetchClient) ([]byte, error) {
	...
	var r0 []byte
	if rf, ok := ret.Get(0).(func(filetransfer.FileTransfer_FetchClient) []byte); ok {
		r0 = rf(stream)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
...
func (_m *FileTransferRepositoryMock) DownloadStream(ctx context.Context, fileName string) (filetransfer.FileTransfer_FetchClient, error) {
	ret := _m.Called(ctx, fileName)

	var r0 filetransfer.FileTransfer_FetchClient
	if rf, ok := ret.Get(0).(func(context.Context, string) filetransfer.FileTransfer_FetchClient); ok {
		r0 = rf(ctx, fileName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(filetransfer.FileTransfer_FetchClient)
		}
	}
...
func (_m *FileTransferRepositoryMock) Upload(stream filetransfer.FileTransfer_StoreClient, fileName string, fileChunk []byte) error {
	ret := _m.Called(stream, fileName, fileChunk)

	var r0 error
	if rf, ok := ret.Get(0).(func(filetransfer.FileTransfer_StoreClient, string, []byte) error); ok {
...
func (_m *FileTransferRepositoryMock) UploadClose(stream filetransfer.FileTransfer_StoreClient) error {
	ret := _m.Called(stream)

	var r0 error
	if rf, ok := ret.Get(0).(func(filetransfer.FileTransfer_StoreClient) error); ok {
		r0 = rf(stream)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *FileTransferRepositoryMock) UploadStream(ctx context.Context) (filetransfer.FileTransfer_StoreClient, error) {
	ret := _m.Called(ctx)

	var r0 filetransfer.FileTransfer_StoreClient
	if rf, ok := ret.Get(0).(func(context.Context) filetransfer.FileTransfer_StoreClient); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(filetransfer.FileTransfer_StoreClient)
		}
	}
